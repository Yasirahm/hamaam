...
const ProductUpload = () => {
  ...
  const handleUpload = async () => {
    if (!name || !description || !details || !size || !location || !price || !imageUrl) {
      Swal.fire({
        icon: "error",
        title: "Oops...",
    ...
    <div className="relative">
      ...
      {showForm && (
        ...
        >
          ...
          <input className="w-full mb-2 p-2 border rounded" type="text" placeholder="Size" value={size} onChange={(e) => setSize(e.target.value)} />
          <input className="w-full mb-2 p-2 border rounded" type="text" placeholder="Location" value={location} onChange={(e) => setLocation(e.target.value)} />
