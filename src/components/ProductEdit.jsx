  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-white shadow-md rounded-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <label className="text-sm text-yellow-800">Size of room</label>
        <input type="text" name="size" value={product.size} onChange={handleChange} className="w-full p-2 border-4 rounded-md" placeholder="Size" required />
        <label className="text-sm text-yellow-800">Location</label>
        <input type="text" name="location" value={product.location} onChange={handleChange} className="w-full p-2 border-4 rounded-md" placeholder="Location" required />
