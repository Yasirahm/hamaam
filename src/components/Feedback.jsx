...
const Feedback = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 border-8 shadow-md rounded-lg">
      <h2 className="text-2xl font-bold text-center mb-6">Customer Feedback</h2>
      ...
      <div className="mt-6">
        ...
        {feedbackList.length === 0 ? (
          <p className="text-gray-600">No feedback yet. Be the first to review!</p>
        ) : (
          <div className="space-y-4">
            {feedbackList.map((feedback) => (
              <div key={feedback.id} className="p-4 bg-gray-100 rounded-lg relative">
                {/* Display Name & Stars */}
